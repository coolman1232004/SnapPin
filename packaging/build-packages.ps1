...
$manifest = [ordered]@{
    ...
    releaseNotes = 'SnapAnchor 2.0.5 makes pinned-image editing open in move mode, aligns its toolbar like capture mode, and lets an active tool be clicked again to return to moving.'
}
