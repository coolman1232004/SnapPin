...
$manifest = [ordered]@{
    ...
    releaseNotes = 'SnapAnchor 2.0.2 removes the obsolete portable executable from both fresh packages and existing updated folders, and adds context-aware OCR text cursors to pinned images.'
}
