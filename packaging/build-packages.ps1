...
$manifest = [ordered]@{
    ...
    releaseNotes = 'SnapAnchor 2.1.1 restores drawing input and exact toolbar alignment on pinned images, and lets capture annotation tools be clicked again to unselect them.'
}
