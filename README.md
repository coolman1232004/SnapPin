...
<p align="center">
  ...
  <img alt="Current version" src="https://img.shields.io/badge/version-2.1.8-292524">
...
- Pixel-exact native pins with smooth high-quality text rendering while resized
...
```powershell
.\packaging\Build-Packages.ps1 -Version 2.1.8
```
