...
$project = Join-Path $PSScriptRoot 'RecognitionSmoke\SnapAnchor.RecognitionSmoke.csproj'
...
$runner = Get-ChildItem -LiteralPath $outputRoot -Recurse -Filter 'SnapAnchor.RecognitionSmoke.dll' -File |
